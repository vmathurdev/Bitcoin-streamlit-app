...
currency = st.radio("Currency",('CAD' , 'USD', 'INR', 'CNY', 'SGD'))
...
st.line_chart(df)
st.write('Average price during this time was',currency, str(df[currency].mean()))


 
st.subheader("The application and code is copyright © of Vinamra Mathur")